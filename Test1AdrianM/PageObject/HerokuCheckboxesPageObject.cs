namespace Objectivity.Test.Automation.Tests.PageObjects.PageObjects.TheInternet
{
	...
	/// The checkboxes page.
	/// </summary>
	public class HerokuCheckboxesPageObject : ProjectPageBase
	{
		/// <summary>
		/// The logger.
		/// </summary>
		...
		public HerokuCheckboxesPageObject(DriverContext driverContext)
			: base(driverContext)
		{
		...
		public HerokuCheckboxesPageObject TickCheckboxOne()
		{
		...
		public HerokuCheckboxesPageObject UnTickCheckboxOne()
		{
		...
		/// </summary>
		/// <returns>Checkboxes Page</returns>
		public HerokuCheckboxesPageObject TickCheckboxTwo()
		{
		...
		public HerokuCheckboxesPageObject UnTickCheckboxTwo()
		{
